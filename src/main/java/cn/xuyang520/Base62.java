...
public class Base62 {
    ...
    private final int defaultEstimatedLength;

    private byte[] lookup;

    private Base62(final byte[] alphabet, int estimatedLength) {
        this.alphabet = alphabet;
        createLookupTable();
        this.defaultEstimatedLength = estimatedLength;
    }
     ...
     */
    public static Base62 createEncoder() {
        return createGmpEncoder();
    }

    public static Base62 createEncoder(int estimatedLength) {
        return createGmpEncoder(estimatedLength);
    }
     ...
     * @return a {@link Base62} instance.
     */
    public static Base62 createGmpEncoder() {
        return new Base62(CharacterSets.GMP, -1);
    }

    public static Base62 createGmpEncoder(int estimatedLength) {
        return new Base62(CharacterSets.GMP, estimatedLength);
    }
    ...
    public static Base62 createInvertedEncoder() {
        return new Base62(CharacterSets.INVERTED, -1);
    }
    ...
    private int estimateOutputLength(int inputLength, int sourceBase, int targetBase) {
        if (defaultEstimatedLength > 0) {
            return defaultEstimatedLength;
        }
